...
item_1_price_right_format = Decimal(item_1_price).quantize(Decimal('0.01'))
...
item_2_price_right_format = Decimal(item_2_price).quantize(Decimal('0.01'))
...
print(printing_template.format(item_1_title, item_1_quantity, item_1_price_right_format, item_1_total_cost_right_format))
print(printing_template.format(item_2_title, item_2_quantity, item_2_price_right_format, item_2_total_cost_right_format))
print('~' * 80)
print(printing_template.format(
    'ВСЬОГО'.ljust(20),
    item_1_quantity + item_2_quantity,
    item_1_price_right_format + item_2_price_right_format,
